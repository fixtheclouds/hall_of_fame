...
return [
    ...
    'Users' => 'Пользователи',
    'VKontakte' => 'ВКонтакте',
    'We have generated a password for you' => 'Мы сгенерировали для вас новый пароль',
    ...
    'Your password on {0} has been changed' => 'Ваш пароль на портале {0} был изменен.',
    'Your account on {0} has a new password' => 'Пароль для вашей учетной записи на портале {0} был спрошен.'
];
