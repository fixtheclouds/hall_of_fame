        ...
        <div class="t-cover" id="recorddiv25085318" bgimgfield="img" style="height: 763px; background-image: url(&quot;https://static.tildacdn.com/tild3666-6565-4439-b838-666631356532/-/resize/20x/2222.jpg&quot;);">
            ...
            <div class="t-container">
                <div class="t-width t-width_10" style="margin:0 auto;">
                    <div class="t-cover__wrapper t-valign_middle" style="height: 763px; position: relative; z-index: 1;">
                        <div class="t182">
                                    ...
                                    <div class="t182__buttons">
                                        <a href="/event/create" target="" class="t-btn " style="color:#ffffff;border-radius:20px; -moz-border-radius:20px; -webkit-border-radius:20px;">
                                            <table style="width:100%; height:100%;">
                                                <tbody>
                                                <tr>
                                                    <td>Рассказать об участии в мероприятии</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </a>
                                        <a href="/account" target="" class="t-btn " style="color:#000000;border-radius:20px; -moz-border-radius:20px; -webkit-border-radius:20px;">
                                            <table style="width:100%; height:100%;">
                                                <tbody>
                                                <tr>
                                                    <td>Стать соавтором книги о почетных гражданах</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </a>
        ...
        <div class="t-cover" id="recorddiv25128776" bgimgfield="img" style="height: 904px; background-image: url(&quot;https://static.tildacdn.com/tild6464-3538-4532-b161-653639646634/-/resize/20x/noroot.jpg&quot;);">
            ...
            <div class="t-container">
                <div class="t-col t-col_7">
                    <div class="t-cover__wrapper t-valign_middle" style="height: 904px; position: relative; z-index: 1;">
                        <div class="t189">
                            <div data-hook-content="covercontent">
        ...
        <div class="t474">
            <div class="t-container t-align_center">
                <div class="t-col t-col_11 t-prefix_1">
                    <div class="t474__descr t-descr t-descr_xxxl t-margin_auto" field="descr" style=""><span style="color: rgb(130, 1, 24);"><strong>О ПРОЕКТЕ </strong><strong></strong><br></span><br> Первый социальный марафон по изучению истории малой Родины через судьбы знаменитых земляков - почетных граждан городов и районов Ростовской области.<br> Самые активные участника марафона <span style="color: rgb(130, 1, 24);"><strong>получают призы. </strong></span><br><br></div>
                </div>
            </div>
        </div>
    </div>
