...
<div class="message-form event-item panel panel-default">
    ...
    <h2>Напишите нам</h2>
    <blockquote>
        Участвуйте в создании третьего тома книги, в которую войдут биографии почетных граждан 23 муниципальных
        образований Ростовской области. Эта книга - наша гордость. Память о тех, кто делает знаменитой нашу малую
